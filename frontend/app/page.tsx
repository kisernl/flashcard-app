...
export default function Home() {
  ...
  //     if (selectedStack) {
  //       const stackDecks = await getDecksByStack(selectedStack.id)
  //       setDecks(stackDecks)
  //     }
  //   }
  //   loadDecks()
  // }, [selectedStack, currentView])

  // API call to load stacks
  useEffect(() => {
  ...
  // API call to refresh decks for the selected stack
  const refreshDecks = async () => {
    if (selectedStack) {
      try {
  ...
  // API call to load decks for the selected stack
